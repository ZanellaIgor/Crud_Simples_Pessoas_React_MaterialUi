...
const NewClient = () => {
  ...
  const addEndereco = () => {
    axios
      .get(`${baseUrl}${cep.replace(/\D/g, '')}/json/`)
  ...
  return (
    <div className="container-new-client">
      ...
      <form
        ...
        onSubmit={handleSubmit(handleButtonForm)}
      >
        <div className="container-dados-clientes">
          ...
          <span>
            ...
            <input
              ...
              name="cnpjcpf"
              type="text"
              {...register('cnpjcpf', { validate: validateCnpjCpf })}
              required
              value={cpfCnpj}
          ...
          <span>
            ...
            <input
              ...
              name="inEst"
              type="text"
              {...register('inEst', { validate: validateInEst })}
              required
              value={ie}
        ...
        <button id="botao-envia-cliente" type="submit">
          Enviar
        </button>
      </form>
    </div>
